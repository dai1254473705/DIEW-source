var App = function () {
    ...
    var handleChat = function () {
        ...
        var handleClick = function () {
            ...
            var tpl = '';
            tpl += '<li class="out">';
            tpl += '<img class="avatar" alt="" src="assets/images/avatar1.jpg"/>';
    ...
    var handleFormWizards = function () {
        ...
        $('#form_wizard_1').bootstrapWizard({
            ...
            onTabClick: function (tab, navigation, index) {
                ...
                h_index = window.location.hash.split("#step")[1]-1;
                var total = navigation.find('li').length;
                var current = h_index + 1;
                // set wizard title
                $('.step-title', $('#form_wizard_1')).text('Step ' + (h_index + 1) + ' of ' + total);
                // set done steps
                ...
                // App.scrollTo($('#content_wizard'), -50);
            },
    ...
    return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="/Public/assets/images/l1.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
        ...
        // wrapper function to  un-block element(finish loading)
        unblockUICompatible: function (el) {
            jQuery(el).unblock({
                onUnblock: function () {
                    jQuery(el).find('.blockUI').removeAttr("style");
                    jQuery(el).find('.blockUI').remove();
                }
            });
        },
